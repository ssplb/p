...
<html>
	<head>
        ...
        <noscript><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ssplb/p@0x01/public/assets/css/noscript.min.css" /></noscript>   
  </head>
       ...
       <body>
			...
			<script src="https://cdn.jsdelivr.net/gh/ssplb/p@0x01/public/assets/js/util.min.js"></script>
         <script src="https://cdn.jsdelivr.net/gh/ssplb/p@0x01/public/assets/js/main.min.js"></script>
	</body>
</html>
